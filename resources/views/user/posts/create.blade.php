...
<head>
    ...
    <title>Create Post - VisionSphere</title>
    ...
    <div class="min-h-screen lg:flex">
        ...
        <div id="sidebar" class="sidebar-transition fixed inset-y-0 left-0 z-50 w-64 bg-white shadow-xl transform -translate-x-full lg:translate-x-0 lg:transform-none lg:opacity-100 lg:static lg:z-auto overflow-y-auto">
            ...
            <nav class="flex-1 px-4 py-6 space-y-2">
                ...
                <a href="{{ route('user.posts.create') }}" class="nav-link flex items-center px-4 py-3 min-h-[44px] text-gray-700 rounded-lg hover:bg-rose-50 hover:text-rose-700 transition-colors duration-200 focus-visible:ring-2 focus-visible:ring-rose-300 bg-rose-100 text-rose-800 border-r-4 border-rose-500">
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600 text-sm">Share your thoughts and stories</p>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                                ...
                                <a href="{{ route('user.posts.index') }}" class="mt-3 w-full inline-flex items-center justify-center px-4 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition">
