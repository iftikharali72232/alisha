...
<div class="max-w-2xl">
    <div class="mb-6">
        <a href="{{ route('admin.sliders.index') }}" class="inline-flex items-center text-gray-600 hover:text-rose-600 transition">
    ...
    <form action="{{ route('admin.sliders.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
            <h3 class="text-lg font-semibold text-gray-900 mb-4">
                <i class="fas fa-image text-rose-500 mr-2"></i>Slider Details
            </h3>
            ...
            <div class="space-y-4">
                ...
                <div>
                    <label for="image" class="block text-sm font-medium text-gray-700 mb-1">Image * <span class="text-gray-400">(Recommended: 1920x600)</span></label>
                    <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-lg hover:border-rose-400 transition" id="dropzone">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
            <h3 class="text-lg font-semibold text-gray-900 mb-4">
                <i class="fas fa-link text-rose-500 mr-2"></i>Link Settings
            </h3>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
            <h3 class="text-lg font-semibold text-gray-900 mb-4">
                <i class="fas fa-cog text-rose-500 mr-2"></i>Settings
            </h3>
        ...
        <div class="flex items-center justify-end space-x-4">
            <a href="{{ route('admin.sliders.index') }}" class="px-6 py-3 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition">
                Cancel
            </a>
